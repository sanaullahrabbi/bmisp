 ...
 * @see Walker
 */
class Walker_Nav_Mobile_Menu extends Walker
{
	/**
	...
	public function start_el(&$output, $data_object, $depth = 0, $args = null, $current_object_id = 0)
	{
		...
		if (in_array('dropdown', $classes)) {
			$custom_class = 'dropdown-toggle';
			$custom_attr = 'dropdown';
		}
		...
		if ($custom_attr):
			$atts['data-bs-toggle'] = $custom_attr;
		endif;
		...
		$item_output .= '<a' . $attributes . ' class="' . $custom_class . '">';
