...
// Image Gallery Filter Js Code
var $grid = $(".grid").isotope({
  // options
});
// filter items on button click
$(".filter-button-group").on("click", "button", function () {
  // remove class name active all button
  $(".filter-button-group button").removeClass("active");

  // add class name this click button
  $(this).addClass("active");
...
// Company Activity Number Counter JS code
$(".count").each(function () {
  $(this)
    .prop("Counter", 0)
    .animate(
